...
class MayanDocument(
    ...
    override suspend fun filename(): String =
        document.fileLatest?.filename ?: ""
    override suspend fun filesize(): Int =
        document.fileLatest?.propertySize ?: -1
    override suspend fun timestamp(): LocalDateTime =
        document.datetimeCreated?.let { LocalDateTime.parse(it, DateTimeFormatter.ISO_LOCAL_DATE_TIME) } ?: LocalDateTime.MIN
